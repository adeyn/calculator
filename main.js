// Главная функция.
// Учитывает аргументы с веб-страницы, выбирает операцию,
// передаёт управление вычисл¤ющей функции и выводит результат
...
function calculate(){
  ...
  switch (operation) {
    ...
    case 'construction2': result=construction2(arg1); break;
    case 'constructionX': result=constructionX(arg1, arg2); break;
